...
public class ViewBookDialog extends JDialog
   ...
   private static ViewBookDialog instance;
    ...
    * @return 
    */
   public ViewBookDialog(boolean useThumbs) {
       //super(TITLE);
       this.setTitle(TITLE);
   ...
   public static ViewBookDialog getInstance(String _fileName) {		
			instance = new ViewBookDialog(true);
			String fileName = _fileName;
		    if (fileName != null) {
		    	instance.doOpen(fileName);
		    }		
		return instance;
	}
...
//       System.out.println("Going to page " + pagenum);
   ...
   public void doOpen(String name) {
       try {
           ...
           try {
               ...
               Logger.getLogger(ViewBookDialog.class.getName()).log(Level.SEVERE, null, ex);
           }
       }
   }
   ...
   class PrintThread extends Thread {
       ...
       public void run() {
           try {
               ...
               JOptionPane.showMessageDialog(ViewBookDialog.this,
   ...
   class PerformFullScreenMode implements Runnable {
       ...
       public void run() {
           ...
           fspp.addKeyListener(ViewBookDialog.this);
           gotoPage(curpage);
...
//       }
//       // start the viewer
       ViewBookDialog viewer;
       viewer = new ViewBookDialog(useThumbs);
       if (fileName != null) {
